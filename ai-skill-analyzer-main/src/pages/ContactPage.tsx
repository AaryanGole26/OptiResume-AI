      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
            Have questions about OptiResume? Need help optimizing your resume? 
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 mb-20">
          <Card className="card-elevated border-0">
            ...
            <CardContent>
              <p className="font-medium">support@optiresume.ai</p>
        ...
        <Card className="card-elevated border-0 mt-16">
          <CardHeader className="text-center">
            ...
            <CardDescription>
              Quick answers to common questions about OptiResume
            </CardDescription>
          </CardHeader>
          <CardContent>
